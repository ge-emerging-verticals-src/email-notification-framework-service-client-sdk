...
public class SendEmailRequestTest {
  ...
  public void TestSendEmailRequestBodyBase() {
    ...
    SendEmailRequestBodyRecipient sendEmailRequestBodyRecipient = new SendEmailRequestBodyRecipient.SendEmailRequestBodyRecipientBuilder(NAME, EMAIL, TYPE)
        .setRecipientName("name")
        .setEmail("email")
        .setType(RecipientType.bcc)
        .build();

    assert(sendEmailRequestBodyRecipient.getEmail().equals("email"));
    assert(sendEmailRequestBodyRecipient.getRecipientName().equals("name"));
    assert(sendEmailRequestBodyRecipient.getType().toString().equals("bcc"));

     sendEmailRequestBodyRecipient = new SendEmailRequestBodyRecipient.SendEmailRequestBodyRecipientBuilder(NAME, EMAIL, TYPE).build();
  ...
  public void TestTemplateEmailRequestBody()
  {
    ...
    assert(sendTemplateEmailRequestBody.toJson().equals(SEND_EMAIL_TEMPLATE_BODY_JSON));
